...
import 'package:thanarak_exchange/presentation/calculate/models/summary_panel_state.dart';
...
class SummaryPanelNotifier extends StateNotifier<SummaryPanelState> {
  ...
  String get totalBuyPriceComma =>
      CustomNumberFormat.commaFormat5(state.totalBuyPrice);
  String get totalSellPriceComma =>
      CustomNumberFormat.commaFormat5(state.totalSellPrice);
